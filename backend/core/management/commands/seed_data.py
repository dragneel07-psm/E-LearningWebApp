...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for tenant in tenants:
            ...
            self.stdout.write(f'  ✓ Created {len(teachers)} teachers, {len(students)} students, {len(parents)} parents')
    ...
    def create_users(self, tenant):
        ...
        # Create students
        student_names = [
            'James Anderson', 'Olivia Martin', 'Liam Garcia', 'Sophia Martinez',
            'Noah Rodriguez', 'Isabella Lopez', 'William Hernandez', 'Mia Gonzalez',
            'Benjamin Wilson', 'Charlotte Moore', 'Lucas Taylor', 'Amelia Anderson',
            'Henry Thomas', 'Harper Jackson', 'Alexander White', 'Evelyn Harris',
            'Daniel Martin', 'Abigail Thompson', 'Matthew Clark', 'Emily Lewis'
        ]
    ...
    def create_parents(self, tenant, students):
        ...
        parents = []
        for i, student in enumerate(students[:15]):  # Create parents for first 15 students
    ...
    def create_courses(self, classes, teachers):
        ...
        courses = []
        subjects = [
            'Mathematics', 'Science', 'English Literature', 
    ...
    def create_results(self, assessments, students):
        ...
        for assessment in assessments:
            ...
            eligible_students = [s for s in students if s.academic_class == course_class]
