...
def setup_demo():
    with schema_context('demo'):
        ...
        klass, _ = AcademicClass.objects.get_or_create(name="Grade 12", defaults={'order': 12})
        ...
        quiz_data = {
            "questions": [
                ...
                },
                {
                    ...
                    "options": ["state.value = newValue", "setState(newValue)", "updateState(newValue)", "this.val = newValue"],
                    "correctIndex": 1,
        ...
        flash_data = {
            "cards": [
                {"front": "JSX", "back": "JavaScript XML. A syntax extension for JavaScript that looks like HTML."},
                {"front": "Props", "back": "Short for properties. Data passed from parent to child components."},
        ...
        print(f"Successfully created demo lessons in subject: {subject.name} (ID: {subject.id})")
