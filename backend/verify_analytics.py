...
def verify_analytics():
    ...
    required_keys = ["at_risk_count", "at_risk_students", "performance_trends", "topic_mastery", "ai_insights"]
    ...
    if missing:
        ...
        if data['at_risk_students']:
            print(f"   - Sample At-Risk Student: {data['at_risk_students'][0]['name']} (Risk: {data['at_risk_students'][0]['risk_level']})")
