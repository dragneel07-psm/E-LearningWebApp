        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.OneToOneField(
                    ...
                    related_name='health_record', to='academic.student',
                )),
                ('tenant', models.ForeignKey(
                    db_constraint=False, on_delete=django.db.models.deletion.CASCADE,
                    related_name='student_health_records', to='core.tenant',
                )),
            ],
            options={'indexes': [models.Index(fields=['tenant'], name='sis_health_tenant_idx')]},
        ),
        # ── ImmunizationRecord ───────────────────────────────────────────────
        migrations.CreateModel(
            name='ImmunizationRecord',
            fields=[
                ('immunization_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ...
                ('health_record', models.ForeignKey(
                    db_constraint=False, on_delete=django.db.models.deletion.CASCADE,
                    related_name='immunizations', to='academic.studenthealthrecord',
                )),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incident_type', models.CharField(
                    choices=[
                        ('misconduct', 'General Misconduct'), ('bullying', 'Bullying'),
                        ('cheating', 'Cheating / Academic Dishonesty'), ('property_damage', 'Property Damage'),
                        ('verbal_abuse', 'Verbal Abuse'), ('physical_altercation', 'Physical Altercation'),
                        ('attendance_violation', 'Attendance Violation'), ('other', 'Other'),
                    ],
                ...
                ('reported_by', models.ForeignKey(
                    ...
                    related_name='reported_incidents', to=settings.AUTH_USER_MODEL,
                )),
                ('student', models.ForeignKey(
                    db_constraint=False, on_delete=django.db.models.deletion.CASCADE,
                    related_name='disciplinary_incidents', to='academic.student',
                )),
                ('tenant', models.ForeignKey(
                    db_constraint=False, on_delete=django.db.models.deletion.CASCADE,
                    related_name='disciplinary_incidents', to='core.tenant',
                )),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issued_by', models.ForeignKey(
                    db_constraint=False, null=True,
                    on_delete=django.db.models.deletion.SET_NULL,
                    related_name='issued_documents', to=settings.AUTH_USER_MODEL,
                )),
                ('student', models.ForeignKey(
                    db_constraint=False, on_delete=django.db.models.deletion.CASCADE,
                    related_name='documents', to='academic.student',
                )),
                ('tenant', models.ForeignKey(
                    db_constraint=False, on_delete=django.db.models.deletion.CASCADE,
                    related_name='student_documents', to='core.tenant',
                )),
            ],
            options={
                'ordering': ['-created_at'],
