                ...
                <Card>
                    ...
                    <CardContent>
                        <MemberList
                            ...
                            members={[]}
                            canManage={canManage}
                            onChanged={() => qc.invalidateQueries({ queryKey: projectKeys.detail(project.project_id) })}
                        />
                        <p className="mt-2 text-xs text-slate-400">
                            Member roster is managed by the mentor. Pass full member list once the
                            backend exposes a project-scoped members endpoint (Phase 4.1).
                        </p>
                    </CardContent>
                </Card>
            </div>
